...
Para poder conectar a la base de datos añadir esto en un archivo .env en la carpeta back: MONGO_URI=mongodb+srv://jesus_trazapie:JESsancat2000%2E@cluster0.nc0jutv.mongodb.net/TrazapieDB?appName=Cluster0
